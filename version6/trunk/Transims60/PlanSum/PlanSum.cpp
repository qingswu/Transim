...
PlanSum::PlanSum (void) : Data_Service (), Select_Service (), Flow_Time_Service ()
{
	...
	int select_service_keys [] = {
		SELECT_HOUSEHOLDS, SELECT_MODES, SELECT_PURPOSES, SELECT_PRIORITIES, SELECT_START_TIMES, SELECT_END_TIMES, 
		SELECT_ORIGINS, SELECT_DESTINATIONS, SELECT_VEHICLE_TYPES, SELECT_TRAVELER_TYPES, 
		SELECT_LINKS, SELECT_NODES, SELECT_SUBAREAS, SELECT_STOPS, SELECT_ROUTES, SELECT_TRANSIT_MODES, 
		SELECTION_POLYGON, SELECTION_PERCENTAGE, 0
	};
