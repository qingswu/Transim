...
protected:
	enum NetPrep_Keys { 
		...
		NEW_LINK_NODE_LIST_FILE, TRANSIT_TIME_PERIODS, TRANSIT_PERIOD_OFFSETS, PERIOD_TRAVEL_TIMES, 
		TRANSIT_NODE_TYPES, COLLAPSE_ROUTE_DATA, FIRST_ROUTE_NUMBER, INPUT_ROUTE_FORMAT,
