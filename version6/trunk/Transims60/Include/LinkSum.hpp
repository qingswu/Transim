...
protected:
	enum LinkSum_Keys { 
		...
		NEW_GROUP_PERFORMANCE_FILE, NEW_GROUP_PERFORMANCE_FORMAT,
...
private:
	enum LinkSum_Reports { TOP_LINK_FLOW = 1, TOP_LANE_FLOW, TOP_PERIOD, TOP_SPEED, 
		...
		PERF_REPORT, PERF_DETAIL, GROUP_REPORT, GROUP_DETAIL, RELATIVE_GAP };

	bool select_flag, activity_flag, zone_flag, group_flag;
	bool compare_flag, group_select, detail_flag, group_perf_flag, turn_vol_flag;
	...
	Db_Header activity_file, zone_file, group_file, detail_file, group_perf_file;
	Integers field_list;
