...
SubareaPlans::Plan_Processing::Plan_Processing (SubareaPlans *_exe)
{
	exe = _exe;
...
SubareaPlans::Plan_Processing::~Plan_Processing (void)
{
	if (plan_file != 0) {
		delete plan_file;
	}
...
void SubareaPlans::Plan_Processing::operator()()
{
	int part = 0;
