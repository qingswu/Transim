...
ArcDelay::ArcDelay (void) : Data_Service (), Select_Service (), Draw_Service ()
{
	Program ("ArcDelay");
	Version (5);
	...
	System_File_Type optional_files [] = {
		...
		VEHICLE_TYPE, LINK_DELAY, PERFORMANCE, END_FILE
	};
...
//		{ LINK_DIR_BY_PERIOD, "LINK_DIR_BY_PERIOD", LEVEL0, OPT_KEY, BOOL_KEY, "FALSE", BOOL_RANGE, NO_HELP },
		{ NEW_ARC_DELAY_FILE, "NEW_ARC_DELAY_FILE", LEVEL0, OPT_KEY, OUT_KEY, "", FILE_RANGE, NO_HELP },
		{ NEW_ARC_INTERSECTION_FILE, "NEW_ARC_INTERSECTION_FILE", LEVEL0, OPT_KEY, OUT_KEY, "", FILE_RANGE, NO_HELP },
		{ NEW_ARC_TURN_FILE, "NEW_ARC_TURN_FILE", LEVEL0, OPT_KEY, OUT_KEY, "", FILE_RANGE, NO_HELP },
	...
	vc_field = vmt_field = vht_field = cong_time_field = cong_vmt_field = cong_vht_field = max_period_field = -1;
	center_flag = lanes_flag = turn_flag = subarea_flag = index_flag = image_flag = shape_flag = max_period_flag = false;
	delay_flag = link_dir_flag = link_data_flag = intersection_flag =  event_flag = link_period_flag = dir_period_flag = false;
