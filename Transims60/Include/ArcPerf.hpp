//*********************************************************
//	ArcPerf.hpp - ArcView Performance Files
//*********************************************************
...
class ArcPerf : public Data_Service, public Select_Service, public Draw_Service
{
public:
	ArcPerf (void);
...
protected:
	enum ArcPerf_Keys { 
		...
		NEW_ARC_LINK_DIR_FILE, LINK_DIR_BY_PERIOD, NEW_ARC_PERFORMANCE_FILE, NEW_ARC_INTERSECTION_FILE, 
		NEW_ARC_TURN_DELAY_FILE, NEW_ARC_TRAFFIC_IMAGE, TRAFFIC_IMAGE_ATTRIBUTE, VEHICLE_TYPE_DISTRIBUTION,
...
private:
	...
	bool perf_flag, link_dir_flag, link_data_flag, intersection_flag, event_flag, max_period_flag;
	...
	void ArcPerf::Draw_Link (Arcview_File &file, Link_Data *link_ptr, int dir = 0);
};
#endif
