...
LinkSum::LinkSum (void) : Data_Service (), Select_Service ()
{
	...
	Control_Key linksum_keys [] = { //--- code, key, level, status, type, default, range, help ----
		...
		{ NEW_GROUP_PERFORMANCE_FILE, "NEW_GROUP_PERFORMANCE_FILE", LEVEL0, OPT_KEY, OUT_KEY, "", FILE_RANGE, NO_HELP },
		{ NEW_GROUP_PERFORMANCE_FORMAT, "NEW_GROUP_PERFORMANCE_FORMAT", LEVEL0, OPT_KEY, TEXT_KEY, "TAB_DELIMITED", FORMAT_RANGE, NO_HELP },
	...
	compare_flag = group_select = detail_flag = group_perf_flag = turn_vol_flag = false;
