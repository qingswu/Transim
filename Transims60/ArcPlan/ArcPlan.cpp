...
ArcPlan::ArcPlan (void) : Data_Service (), Select_Service (), Draw_Service ()
{
	...
	int select_service_keys [] = {
		...
		SELECT_TRAVELER_TYPES, SELECT_FACILITY_TYPES, SELECT_TRANSIT_MODES, SELECT_ROUTES,
		SELECT_VEHICLE_TYPES, SELECT_PROBLEM_TYPES, SELECT_LINKS, SELECT_SUBAREAS, 
		SELECT_ORIGIN_ZONES, SELECT_DESTINATION_ZONES, SELECTION_POLYGON, SELECTION_PERCENTAGE, 0
